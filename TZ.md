...
## Формат логов. Основная задача  в том, что логи могу быть различных форматов. Какой заранее не известен, поэтому нужно уметь вытягивать максимум метрик из того что приходит на вход.
